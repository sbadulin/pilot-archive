...
export default function Home() {
  ...
  return <>
    ...
    {screen.kind === 'upload' ? <Upload onBack={back} /> : <main id="main" className="shell archive-page">
      ...
      <section className="about-section" id="about"><div><span className="black-label">О газете</span><h2>Свой город. <br />Своё поколение.</h2></div><div><p>«Первый Пилот» — молодёжная газета Комсомольска-на-Амуре. Здесь собираем выпуски за 1996–2007 годы, чтобы их снова можно было читать.</p><p>В выпусках газеты: городские новости, музыка, кино, письма читателей и телепрограмма. Газета остаётся целиком — вместе с рекламой и кроссвордами.</p></div><aside><h3>Сохранился выпуск?</h3><p>Попробуйте добавить PDF. Для этого не нужны специальные программы.</p><button className="underlined-button" onClick={() => navigate({ kind: 'upload' })}>Добавить выпуск<ArrowRight size={18} /></button><small>После проверки куратором выпуск появится в архиве</small></aside></section>
      <section className="creators-section" id="creators" aria-labelledby="creators-title"><div className="creators-heading"><span className="black-label">Люди «Пилота»</span><h2 id="creators-title">Газету делали<br />сами люди.</h2><p>Имена людей, связанных с газетой. Состав постепенно уточняем по сохранившимся номерам и воспоминаниям.</p></div><div className="creator-list"><article><strong>Олеся Луконина</strong></article><article><strong>Константин Луконин</strong></article><article><strong>Павел Трутнев</strong></article><article><strong>Александр Бочкарев</strong></article><article><strong>Вадим Горуленко</strong></article><article><strong>Ульяна Крикливая</strong></article><article><strong>Алексей Ларин</strong></article><article><strong>Светлана Гулай</strong></article><article><strong>Наталья Останина</strong></article><article><strong>Ольга Харламова</strong></article><article><strong>Анна Сидорова</strong></article><article><strong>Сергей Долженко</strong></article><article><strong>Сергей Бадулин</strong></article><article><strong>Марина Бабич</strong></article><article><strong>Кирилл Маковеев</strong></article><article><strong>Александр Утюпин</strong></article><article><strong>Ирина Луконина</strong></article><article><strong>Леонид Шевченко</strong></article><article><strong>Евгения Белоусова</strong></article><article><strong>Захар Веселов</strong></article><article><strong>Владимир Ерошенко</strong></article><article><strong>Дарья Демешко</strong></article></div></section>
    </main>}
